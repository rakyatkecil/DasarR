...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x}\SpecialCharTok{$}\NormalTok{nama}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{barplot}\NormalTok{(x}\SpecialCharTok{$}\NormalTok{Pasien, }
        \AttributeTok{names.arg =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{Hari)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pie}\NormalTok{(x}\SpecialCharTok{$}\NormalTok{jumlah, }\AttributeTok{labels =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{label)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.75\linewidth,height=0.75\textheight]{dr_files/figure-latex/unnamed-chunk-43-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,height=0.75\textheight]{dr_files/figure-latex/unnamed-chunk-44-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,height=0.75\textheight]{dr_files/figure-latex/unnamed-chunk-46-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,height=0.75\textheight]{dr_files/figure-latex/unnamed-chunk-46-2} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,height=0.75\textheight]{dr_files/figure-latex/unnamed-chunk-47-1} \end{center}
...
\includegraphics{dr_files/figure-latex/unnamed-chunk-49-1.pdf}
...
\begin{center}\includegraphics[width=0.75\linewidth,height=0.75\textheight]{dr_files/figure-latex/unnamed-chunk-51-1} \end{center}
